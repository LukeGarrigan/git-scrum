...
describe('when a standard commit provided', () => {
    const standardCommit =
        "d1fc568ce0e61c117dee9bf9872ec55238810 c81b06bf681dfb6c76110e3245b8ed4fb5439e3d Luke Garrigan <lukegarrigan8@gmail.com> 1601545523 +0100	commit: Fixed issue where intent labels don't have colour";

    test('should extract date from string', () => {
        const commit = Commit.fromCommitLine(standardCommit);
        const d = new Date(0);
    ...
    test('should extract name from string', () => {
        const commit = Commit.fromCommitLine(standardCommit, 'master');
...
describe('When just one name', () => {
    const justOneNameCommit =
        "d1fc568ce0e61c117dee9bf9872ec55238810 c81b06bf681dfb6c76110e3245b8ed4fb5439e3d Luke <lukegarrigan8@gmail.com> 1601545523 +0100	commit: Fixed issue where intent labels don't have colour";

    test('should extract just one name', () => {
        const commit = Commit.fromCommitLine(justOneNameCommit);
...
describe('When three names provided', () => {
    const justOneNameCommit =
        "d1fc568ce0e61c117dee9bf9872ec55238810 c81b06bf681dfb6c76110e3245b8ed4fb5439e3d Luke Michael Garrigan <lukegarrigan8@gmail.com> 1601545523 +0100	commit: Fixed issue where intent labels don't have colour";
    ...
    test('should extract commit message', () => {
        const commit = Commit.fromCommitLine(justOneNameCommit, 'master');
        expect(commit.message).toBe("Fixed issue where intent labels don't have colour");
    });
});
